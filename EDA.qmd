...
This project's data was sourced from the CDC's 2015 Behavioral Risk Factor Surveillance System (BRFSS) and was accessed from www.kaggle.com.
...
#diabetes_binary_f, highbp_f, sex_f, income_f, age_f, bmi
 diabetes |>
  group_by(highbp_f) |>
  summarize(count = n()) |>
  arrange(desc(count)) 
...
psych::describe(diabetes$menthlth)
...
#ggplot showing BMI is much more consistently populated throughout the dataset
