...
# Random Forest Models
  ...
  Each tree model makes a different prediction and the overall prediction is determined by a "majority vote" (most common prediction) in classification scenarios, or a numeric average in regression scenarios. 
```{r}
...
#Function for API File

fx_pred <- function(sex_value = "female", income_value = "75k+", age_value = "60 to 64", highbp_value = "no high BP", bmi_value = 28){
...
fx_pred(bmi_value = 50, income_value = "< 10k", highbp_value = "high BP")
```
